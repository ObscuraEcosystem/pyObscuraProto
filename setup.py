...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        # Allow passing extra CMake options via environment (used by cibuildwheel)
        ...
        subprocess.check_call(["cmake", ext.sourcedir] + cmake_args, cwd=build_directory, env=env)
...
setup(
    ...
    long_description="A Python wrapper for ObscuraProto, providing high-level "
    "WebSocket server and client functionalities.",
